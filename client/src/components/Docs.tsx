...
import { Bold, List, Link2, AtSign, Code, Save, Trash } from 'lucide-react';
                ...
                <div className="rounded-md bg-white">
                    <div className="px-4 py-2 flex items-center gap-2 border-b border-gray-200 flex-wrap">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button className="p-2 rounded-full bg-blue-600 text-white focus:border-4 border-blue-400" onClick={() => setSelectedColor('blue')}></button>
                        </div>
                    </div>
